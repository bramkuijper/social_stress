    ...
    }
{
    ...
    // TABORSKY VALIDATION:
    // Initialise damage consistently with the starting hormone.
    // With g = 1 and k = 1, this gives initial damage = hormone.
    if (params.g > 0.0)
    {
        damage =
            params.k *
                ...
                std::mt19937 &rng_r) 
{
    ...
    else
    {
      ...
      // TABORSKY VALIDATION:
      // Taborsky newborns begin with damage generated by their
      // inherited starting hormone.
      damage =
          param.k *
          stress_hormone;
